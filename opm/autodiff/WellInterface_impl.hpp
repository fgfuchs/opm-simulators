...
namespace Opm
{
                              ...
                              Opm::DeferredLogger& deferred_logger)
    {
        ...
        do {
            ...
            OPM_CHECK_FOR_EXCEPTIONS_AND_THROW(exception_thrown, "assembleWellEq in WellInterface::solveWellEqUntilConverged() failed.");

            ConvergenceReport report;
            try {
                report = getWellConvergence(B_avg, deferred_logger);
            } catch (...) {
                exception_thrown = 1;
            }

            OPM_CHECK_FOR_EXCEPTIONS_AND_THROW(exception_thrown, "getWellConvergence in WellInterface::solveWellEqUntilConverged() failed.");
            ...
            OPM_CHECK_FOR_EXCEPTIONS_AND_THROW(exception_thrown, "solveEqAndUpdateWellState in WellInterface::solveWellEqUntilConverged() failed.");
